...
//                }
            ...
            dataArray.add(0); //thức duoi khi
            dataArray.add(0); //icon duoi khi
    ...
    public static void updatePlayer(Player player) {
        if (player.iDMark.isLoadedAllDataPlayer()) {
            ...
            try {
                ...
                dataArray.add((player.itemTime.isThucAn ? (ItemTime.TIME_THUC_AN - (System.currentTimeMillis() - player.itemTime.lastTimeThucAn)) : 0));
                dataArray.add(player.itemTime.iconThucAn);
                String itemTime = dataArray.toJSONString();
                dataArray.clear();
