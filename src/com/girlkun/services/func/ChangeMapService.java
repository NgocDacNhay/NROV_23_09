...
public class ChangeMapService {
    ...
    private static final byte EFFECT_GO_TO_KHI_GA = 1;
    private static final byte EFFECT_GO_TO_BDKB = 5;
...
//        Logger.log(Logger.PURPLE, "finish load map player " + player.name + "\n");
    ...
    public void goToGas(Player player) {
        if (!player.iDMark.isGoToGas()) {
            ...
            spaceShipArrive(player, (byte) 1, DEFAULT_SPACE_SHIP);
            effectChangeMap(player, 60, EFFECT_GO_TO_KHI_GA);
        }
    }

    public void goToBdkb(Player player) {
